            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                <div className="bg-white rounded-2xl p-2 border border-stone-200 flex gap-2 mb-8">
                    <button
                        ...
                        className={`flex-1 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 transition ${tab === "payment"
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 transition ${tab === "delivery"
                                ? "bg-green-700 text-white"
                                : "text-stone-700 hover:bg-stone-100"
                            }`}
                    >
