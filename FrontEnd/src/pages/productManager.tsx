...
export function ProductManagement() {
  ...
  const [filteredProducts, setFilteredProducts] = useState<Product[]>([]); //pq esse
  ...
  const [productToDelete, setProductToDelete] = useState<Product | null>(null); //pq esse?
  ...
  return (
    <div className="min-h-screen bg-stone-50 bg-gradient-to-r">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-green-700 text-white hover:bg-green-800 rounded-lg transition-colors font-medium w-fit shadow-sm"
              >
                <Plus size={20} />
      ...
      <main className="container mx-auto px-4 py-8 ">
        {/* Busca e Filtros */}
        <div className="bg-white rounded-xl p-6 border border-stone-200 green shadow-sm mb-6">
        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-white rounded-xl p-12 border border-stone-200 text-center">
            ...
            {products.length === 0 && (
              <button
                onClick={() => navigate("/agricultor/produtos/novo")}
                className="inline-flex items-center gap-2 px-6 py-3 bg-green-700 text-white hover:bg-green-800 rounded-lg transition-colors font-medium"
              >
                <Plus size={20} />
                Adicionar Produto
              </button>
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start gap-3 mb-3">
                      <div className="flex-1">
                        ...
                        {/* AJUSTE AQUI: Alterado para grid-cols-2 (2 colunas no mobile) */}
                  ...
                  <div className="flex md:flex-col gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-stone-100 text-stone-700 hover:bg-stone-200 rounded-lg transition-colors font-medium"
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-red-100 text-red-700 hover:bg-red-200 rounded-lg transition-colors font-medium"
      ...
      <div className="flex justify-center items-center gap-4 mt-6">
        <button
          ...
          className="px-4 py-2 bg-stone-800 text-white rounded hover:bg-stone-900 disabled:bg-stone-300 disabled:text-stone-500 disabled:opacity-100"
        >
          Anterior
        </button>
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 bg-stone-100 text-stone-700 hover:bg-stone-200 rounded-lg transition-colors font-medium"
              >
                Cancelar
              </button>
              <button
                onClick={handleDeleteProduct}
                className="flex-1 px-4 py-3 bg-red-600 text-white hover:bg-red-700 rounded-lg transition-colors font-medium"
              >
                Excluir
              </button>
            </div>
